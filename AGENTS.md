...
- `rive-animation` — trigger keywords: `rive`, `animated vector`, `3d without three`, `micro-interaction`, `motion graphic`. Use Rive (NOT Three.js) for decorative/vector "3D" visuals + Lenis smooth-scroll scroll-driven effects. Learned from landonorris.com.
